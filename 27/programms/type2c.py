# Ищем сумму, делящуюся на 3, потому руководствуемся теорией чисел (a * b + k = c => складываем числа с разностными
# остатками от деления на n и получаем число делящееся на n ((2n-k) + k) % n = 0 )
